package mich.gwan.katharaka.activities.gas;
...
import mich.gwan.katharaka.adapters.gas.GasSaleRecyclerAdapter;
import mich.gwan.katharaka.adapters.pdf.PDFBolt;
import mich.gwan.katharaka.adapters.pdf.PDFGas;
import mich.gwan.katharaka.databinding.ActivityGassalesListBinding;
...
public class GasSaleListActivity extends AppCompatActivity implements PDFGas.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Katharaka/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_GasSales.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_katharaka_gas_sale_data.xls";
