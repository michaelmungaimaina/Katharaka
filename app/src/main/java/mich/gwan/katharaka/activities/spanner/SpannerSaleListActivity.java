package mich.gwan.katharaka.activities.spanner;
...
import mich.gwan.katharaka.adapters.pdf.PDFSpanner;
import mich.gwan.katharaka.adapters.spanner.SpannerSaleRecyclerAdapter;
import mich.gwan.katharaka.databinding.ActivitySpannersalesListBinding;
...
public class SpannerSaleListActivity extends AppCompatActivity implements PDFSpanner.OnDocumentClose {
    ...
    protected void onCreate(Bundle savedInstanceState){
       ...
       // getSupportActionBar().setTitle("Spanners Transactions");
        ActivityCompat.requestPermissions(SpannerSaleListActivity.this, new String[] {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Katharaka/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_Spanner.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_katharaka_spanner_sale_data.xls";
