package mich.gwan.katharaka.activities.welding;
...
import mich.gwan.katharaka.adapters.pdf.PDFWelding;
import mich.gwan.katharaka.adapters.welding.WeldingSaleRecyclerAdapter;
import mich.gwan.katharaka.databinding.ActivityWeldingsalesListBinding;
...
public class WeldingSaleListActivity extends AppCompatActivity implements PDFWelding.OnDocumentClose{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        ActivityCompat.requestPermissions(WeldingSaleListActivity.this, new String[] {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Katharaka/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_welding.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_katharaka_welding_sale_data.xls";
