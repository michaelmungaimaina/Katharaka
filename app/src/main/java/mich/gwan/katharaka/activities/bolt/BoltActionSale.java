...
import static mich.gwan.katharaka.sql.DatabaseHelper.COLUMN_BOLT_CATEGORY;
import static mich.gwan.katharaka.sql.DatabaseHelper.COLUMN_BOLT_QUANTIY;
import static mich.gwan.katharaka.sql.DatabaseHelper.TABLE_BOLT;
...
import mich.gwan.katharaka.databinding.ActivityBoltSaleBinding;
import mich.gwan.katharaka.helpers.InputValidation;
