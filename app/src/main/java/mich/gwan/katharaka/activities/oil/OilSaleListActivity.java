package mich.gwan.katharaka.activities.oil;
...
import mich.gwan.katharaka.activities.LoginActivity;
...
import mich.gwan.katharaka.adapters.oil.OilSaleRecyclerAdapter;
import mich.gwan.katharaka.adapters.pdf.PDFBolt;
import mich.gwan.katharaka.adapters.pdf.PDFOil;
import mich.gwan.katharaka.databinding.ActivityOilsalesListBinding;
...
public class OilSaleListActivity extends AppCompatActivity  implements PDFOil.OnDocumentClose{
    ...
    private  void initViews(){
        ...
        toDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toDatePickerDialog = new DatePickerDialog(OilSaleListActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @SuppressLint("SetTextI18n")
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        if (dayOfMonth < 10 ){
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Katharaka/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_OilSales.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        xssfSheet.createFreezePane(0,0,1, listOilSale.size() + 2 );
        ...
        String filename = m.format(t) + "_katharaka_oil_sale_data.xls";
