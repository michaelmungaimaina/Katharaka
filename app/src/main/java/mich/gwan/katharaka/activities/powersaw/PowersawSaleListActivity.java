package mich.gwan.katharaka.activities.powersaw;
...
import mich.gwan.katharaka.adapters.pdf.PDFPowersaw;
import mich.gwan.katharaka.adapters.powersaw.PowersawSaleRecyclerAdapter;
import mich.gwan.katharaka.databinding.ActivityPowersawsalesListBinding;
...
public class PowersawSaleListActivity extends AppCompatActivity implements PDFPowersaw.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Katharaka/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_powersaw.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_katharaka_powersaw_sale_data.xls";
